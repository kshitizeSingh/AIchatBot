// src/utils/DocumentPickerWeb.tsx
// Web-compatible document picker implementation
...
export class DocumentPickerWeb {
  static types = {
    allFiles: '*/*',
    images: 'image/*',
  ...
  static pickSingle(options: DocumentPickerOptions = {}): Promise<DocumentPickerResponse> {
    return this.pick({ ...options, allowMultiSelection: false })
      .then(results => {
        if (results.length === 0) {
